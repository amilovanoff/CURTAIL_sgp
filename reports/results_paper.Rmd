...
ggplot()+
  ...
  labs(y=expression("2020-2050 average electricity GHG intensity (kg CO"[2]*" eq./kWh)"),x="Complete electrification target year")+
...
plot_dt$Scenario <- factor(plot_dt$Scenario,levels = c("Transition to renewable","Constant"))
