...
#Technology order
car_techno_order <- c("ICEV-G","ICEV-D","HEV-G","HEV-D","CNG","PHEV","BEV")
moto_techno_order <- c("ICEM-G","EM")
bus_techno_order <- c("ICEB-G","ICEB-D","HEB-G","HEB-D","CNGB","EB")
#Color by technology
color_car <- c("ICEV-G"="#1f78b4","ICEV-D"="#d95f02","HEV-G"="#a6cee3","HEV-D"="#fdbf6f","CNG"="#bebada","PHEV"="#b2df8a","BEV"="#33a02c")
color_moto <- c("ICEM-G"="#1f78b4","EM"="#33a02c")
color_bus <- c("ICEB-G"="#1f78b4","ICEB-D"="#d95f02","HEB-G"="#a6cee3","HEB-D"="#fdbf6f","CNGB"="#bebada","EB"="#33a02c")
...
```{r transport_stock_ev,fig.height=2.5, fig.width=3}
res <- read_def_outputs_f(function_tbc="transport_veh_pop_f",scen_tbc="scen1")
...
for (scen in c("PC_EV","PT_EV")){
  dt <- subset(res[["transport_vint_veh_pop_dt"]],Scenario==scen & Year%in%years_tbc)
  for (mode in c("Taxi","Public bus","Private car")){
    #Techno order
    color_value_name <- switch(mode,
                                `Private car`="color_car",
                                `Private hire car`="color_car",
    ...
    ggsave(paste0("outputs/plots/si/proj_stock_techno_",mode,"_",scen,".png"),plot+theme(legend.position = "none"),width=3,height=2.5,units=c("in"),dpi=600)
  }
}
...
plot_w_leg <- plot + 
  ...
  scale_fill_manual(values=color_values,labels=c("ICEV-G"="ICEV-G","ICEV-D"="ICEV-D","HEV-G"="HEV-G","HEV-D"="HEV-D","CNG","PHEV","BEV"))
plot_legend_colour <- get_legend(plot_w_leg)
ggsave("outputs/plots/si/proj_stock_techno_leg.png",plot=plot_legend_colour,width=6,height=0.3,units=c("in"),dpi=600)
